// TCU DOME Dome Karts Backpacks
	
	class B_AssaultPack_blk_DOME_STD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_DOME_LSTD: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_DOME_MRK: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_DOME_MMD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_TacticalPack_blk_DOME_DMK: B_TacticalPack_blk
    {
        scope = 1;
