// TCU FEDO Fedora Syndicate Backpacks
	
	class B_AssaultPack_blk_FEDO_STD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_FEDO_LSTD: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_FEDO_MRK: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_FEDO_MMD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_TacticalPack_blk_FEDO_DMK: B_TacticalPack_blk
    {
        scope = 1;
