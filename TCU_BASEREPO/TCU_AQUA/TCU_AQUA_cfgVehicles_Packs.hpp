// TCU AQUA Aqua Simul Backpacks
	
	class B_AssaultPack_blk_AQUA_STD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_AQUA_LSTD: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_AQUA_MRK: B_TacticalPack_blk
    {
        scope = 1;
	...
	class B_AssaultPack_blk_AQUA_MMD: B_AssaultPack_blk
    {
        scope = 1;
	...
	class B_TacticalPack_blk_AQUA_DMK: B_TacticalPack_blk
    {
        scope = 1;
